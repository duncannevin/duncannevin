...
const about = Object.assign({
  ...
  technicalSkills: [
    ...
    new TechnicalSkill('CSS', 90),
    new TechnicalSkill('Sass', 70),
    new TechnicalSkill('HTML', 90),
    new TechnicalSkill('Angular', 75),
    new TechnicalSkill('AngularJS', 90),
    new TechnicalSkill('VueJS', 890),
    ...
    new TechnicalSkill('NestJS', 80),
    new TechnicalSkill('MongoDB', 70),
    new TechnicalSkill('MySql', 65),
    new TechnicalSkill('Jenkins', 65),
    new TechnicalSkill('AWS', 55),
...
const projects = Object.assign({list: [
  new Project('Loris Editor', 'https://loris-edit.herokuapp.com/', 'A coding collaboration tool. Just share the url with anyone you want to write code with.'),
